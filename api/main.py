...
color_ranges = {
	...
	'roHV': {
		'ranges': [-np.inf, 0, 0.5, 0.6, 0.7, 0.8, 0.85, 0.9, 0.95, 0.97, 0.98, 0.99, 1, np.inf,],
		'colors': [
			'#ffffff',
			'#441C02',
			'#833B00',
	...
	'Sg': {
		'ranges': [-np.inf, 0, 0.5, 1, 2, 3, 4, 5, 6, 7, 8, np.inf,],
		'colors': [
			'#ffffff',
			'#E3F7F8',
			'#CBF8F3',
	...
	'Tb': {
		'ranges': [-np.inf, 0, 10, 100, 400, np.inf,],
		'colors': ['#ffffff', '#E6E6E6', '#FDCD00', '#FF3300', '#CC0003'],
	},
	'DPmap': {
		'ranges': [
	...
	'R': {
		'ranges': [-np.inf, 0.02, 0.1, 0.3, 0.5, 1, 3, 5, 7, 10, 20, 30, 50, 100, np.inf,],
		'colors': [
			'#ffffff',
			'#9B9B9B',
			'#868887',
	...
	'Qp3': {
		'ranges': [-np.inf, 0.01, 0.05, 0.1, 0.3, 0.5, 1, 2, 3, 5, 7, 10, 20, 30, 50, np.inf,],
		'colors': [
			'#ffffff',
			'#FFAAFF',
			'#D0E9FF',
...
def render_tile(data, variable):
    ...
    try:
        ...
        bounds = [
            ...
            else -np.inf if x == '-inf' 
            else np.inf if x == 'inf' 
            else x for x in ranges
        ]
